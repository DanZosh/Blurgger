...
app.use(express.static("public")) //THIS MAKES THE FOLDER PUBLIC AND GIVES THE BROWSER ACCESS TO THE CONTENT
...
app.listen(PORT, function() { 
    console.log("App listening on: http://localhost:" + PORT);// LOG THE CONSOLE WHEN OUR SERVER HAS OPENED AND PROVIDE THE LINK!
});
